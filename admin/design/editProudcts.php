    ...
    <div class="form-group">
        ...
        <select name="category" id="" class="form-control">
            ...
            while ($reslut_cat = $show_cat->fetch_assoc()):
                ?>
            <option value="<?= $reslut_cat["id"] ?>"> <?= $product['category']?> <?= $reslut_cat["name"]?></option>
                <?php
            endwhile;
            ?>
        </select>
    ...
    <div class="form-group">
        ...
        <select name="brand" id="" class="form-control" >
            ...
            while ($reslut_brand = $show_brand->fetch_assoc()):
                ?>
            <option  value="<?=$reslut_brand["id"]?>"<?php
            
              if($reslut_brand['id'] == $reslut_brand["name"]) echo"selected";

              ?>>
            <?=$reslut_brand["name"]?></option>
            <?php
            endwhile;
            ?>
        </select>
